...
def set_gripper_data(gripper_handle, open, velocity=0.15, force=100):
    sim = sims['UR5']
    if not open:
        velocity = -velocity
...
def ur5_ik_control():
    ...
    try:
        ...
        # Pick up the object
        pick_object(sim, simIK, goal_name, gripper_handle, sim_tip, sim_target, ik_env, ik_group, auxData)
